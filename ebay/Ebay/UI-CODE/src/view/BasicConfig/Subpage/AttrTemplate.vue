      ...
      <div class="desc-temp-body">
        <div class="desc-temp-body-left">
          <div class="store-categories margin-b10">
            <div class="store-categories-title" @click="clickstore">Store Categories</div>
              ...
              <div class="tab-wrapper">
                ...
                <div v-for="tab in tabBarData" :key="tab.num">
                  <input
                    ...
                    checked
                  />
                  <label :for="`tab-radios-${tab.num}`" class="tab-handler">{{tab.name}}</label>
                  <div class="tab-content" v-html="tab.value"></div>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    getArrTemplateData() {
      if (this.templateId == this.desc_tpl_id && this.templateData) {
        ...
        let params = {
          id: this.templateId || this.$route.query.templateId,
        };
        this.$axios
    ...
    saveTemplate(status, tmpId) {
      ...
      formdata.append("template_id", tmpId || this.$route.query.templateId);
    ...
    getTemplateCode() {
      let templateCSS = `
        * {
        ...
        .shop-list-li .template_icon-link {
          color: #000;
      ...
      this.tabBarData.forEach((tab, index) => {
        arrHTML_tab.push(`
           <li>
            ...
            <label  for="tab-radio-${index}"  class="tab-handler"  >${tab.name}</label>
            <div class="tab-content" >${tab.value}</div> 
          </li>
 ...
 `);
          ...
          <!--  左边  -->
            <div class="desc-temp-body-left">
              <div class="store-categories margin-b10">
                ...
                <div class="store-categories-content"> </div>
              </div>
              <div class="repeat-bg"></div>
            </div>
          <!--  右边  -->
              ...
              <div class="desc-temp-switch margin-b10">
                 ...
                 <div class="pic">
                  <div class="box" style="width:${
                    this.carouselImages.length * 100
                  }%">
                    ${arrHTMLpic.join("")}
                  </div>
                 </div>
        ...
        <div class="description-template-edit">
          ...
          <!--  左边  -->
            <div class="desc-temp-body-left">
              <div class="store-categories margin-b10">
                <div class="store-categories-title">Store Categories</div>
                <div class="store-categories-shopList"> 
                  <ul  class="shop-list">
                    ${shopsArr.join("")}
                  </ul>
                </div>
      ...
      this.templateCode = `<!DOCTYPE html>
                    <html lang="en">
                    <head>
                        <meta charset="UTF-8">
                    ...
                    <body>
                    ${`<style>${templateCSS}</style>` + templateHTML}
                    </body>
                    </html> `;
