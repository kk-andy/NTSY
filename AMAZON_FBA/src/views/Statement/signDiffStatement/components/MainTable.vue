<template>
  <div>
    ...
    >
      <el-table-column type="expand">
        <template slot-scope="scope">
          ...
          >
            ...
            <el-table-column
              width="100"
              prop="difference_first_leg"
              label="差异头程"
              align="center"
            />
            <el-table-column
              width="100"
              prop="difference_cost"
              label="差异成本"
              align="center"
            />
            <el-table-column
              width="100"
              prop="difference_total_amount"
              label="差异金额"
              align="center"
            />
          </el-table>
      ...
      <el-table-column width="100" label="差异数量" align="center" />
      <el-table-column width="100" label="差异头程" align="center" />
      <el-table-column width="100" label="差异成本" align="center" />
      <el-table-column width="100" label="差异金额" align="center" />
      <el-table-column />
    </el-table>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...mapMutations("StatementDiff", ["CHANGE_tableSel"]),
    //多选
    selectionChange(arg) {
      this.CHANGE_tableSel(arg);
    },
    //合并
