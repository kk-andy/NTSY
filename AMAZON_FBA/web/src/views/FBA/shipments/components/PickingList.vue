      ...
      <table border="1" cellspacing="0" cellpadding="0" width="800px">
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div style="width: 100%">
                <JsBarcode v-if="hasCode" :content="[tableData.shipment_id]" />
              </div>
            </td>
            <td>
          ...
          <tr>
            <td colspan="7">
              <p
                ...
                "
              >
                1.所有发往亚马逊的货件，单箱限重23KG，单边不超过63.5cm---硬性要求
              </p>
              <p
                style="
                  color: red;
                ...
                "
              >
                2.超过15KG需要贴对应国家语言的超重标签，套箱贴MADE IN CHINA标签
              </p>
              <p
                style="
                  color: red;
