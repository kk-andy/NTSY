<template>
  <div class="main">
    ...
    <rebateOperationTable
      :tableData="assessrefundagainList.list"
      @selectionChange="selectionChange"
      @numberClick="numberClick"
    />
    <div class="change_page">
      <page-total
        :total="assessrefundagainList.total"
        :size="form.size"
...
export default {
  ...
  computed: {
    ...mapState({
      assessrefundagainList: (state) =>
        state.financialManagement.assessrefundagainList,
      ...
      showButtons: (state) => state.onceAgainRebate.showButtons,
  ...
  created() {
    ...
    this.$store.dispatch("onceAgainRebate/getButtonList", { id });
  },
  mounted() {
    this.getData();
  ...
  methods: {
    getData(data) {
      ...
      this.$store.dispatch(
        "financialManagement/getAssessrefundagain",
        this.form
      );
    },
    numberClick(data) {
