      ...
      <el-form ref="form" :model="form" label-width="120px" :rules="rules">
        ...
        <el-col :span="24" style="text-align:center;">
          <el-form-item v-show="isEdit">
            <el-button type="primary" @click="isEdit=false">返款</el-button>
      ...
      <div class="modal_tontent">
        <el-form ref="abnormal" :model="abnormal" :rules="rules1" label-width="80px">
          ...
          <el-form-item>
            ...
            <el-button @click="cancel('abnormal')">取消</el-button>
          </el-form-item>
        </el-form>
      </div>
    </Modal>
...
export default {
  ...
  methods: {
    async getList() {
      let res = await assessrefundRead({ id: this.paramsId });
      let form = {
        ...this.formData1,
        ...this.formData2,
      };
    ...
    submitForm() {
      this.$refs["form"].validate(async (valid) => {
        if (valid) {
          ...
          let res = await assessrefundSubmit(data);
          if (res.code == 0) {
            this.$message({
              message: res.message,
              type: "success",
            ...
            setTimeout(() => {
              this.$router.push({ name: "RebateOperation" });
            }, 2000);
          }
        }
      });
