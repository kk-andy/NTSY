<template>
  <div class="main">
    ...
    <leaveReviewTrackingTable
      :tableData="assessreviewList.list"
      @selectionChange="selectionChange"
      @numberClick="numberClick"
    />
    <div class="change_page">
      <page-total
        :total="assessreviewList.total"
        :size="form.size"
...
<script>
import leaveReviewTrackingTable from "./table/leaveReviewTrackingTable";
import { mapState } from "vuex";
export default {
  components: { leaveReviewTrackingTable },
  computed: {
    ...mapState({
      assessreviewList: (state) => state.releaseManagement.assessreviewList,
      ...
      showButtons: (state) => state.leaveReviewTracking.showButtons,
    }),
    modal_fail: {
      get() {
  ...
  created() {
    ...
    this.$store.dispatch("leaveReviewTracking/getButtonList", { id });
  },
  mounted() {
    this.getData();
  ...
  methods: {
    ...
    getData(data) {
      ...
      this.$store.dispatch("releaseManagement/getAssessreview", this.form);
    },
    numberClick(data) {
      this.$router.push({
